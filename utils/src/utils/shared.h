...
typedef enum
{
	...
	LECTURA_HECHA,
	OUT_OF_MEMORY,
	LEER_MEMORIA_PALABRA_DIALS_FS,

	//IO
	CREAR_INTERFAZ,
	HABLAR_CON_IO,
	LEER_MEMORIA_PALABRA,
	DEVOLVER_STRING_STDOUT,
	LIBERAR_INTERFAZ,
	ESCRIBIR_MEMORIA_IO,
	DEVOLVER_STRING_FS,
	ESCRIBIR_MEMORIA_IO_FS,
	LEER_MEMORIA_UN_STRING_FS,
